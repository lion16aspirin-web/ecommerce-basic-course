# CLAUDE.md — ecommerce-basic-course

## What is this project
Ukrainian basic e-commerce course platform. Teaches launching an online store using Ukrainian market tools: Shopify, Хорошоп, KeyCRM, and Нова Пошта.
...
3. **ecommerce-basic-course** (цей проєкт) — Базовий E-Commerce: Shopify, Хорошоп, KeyCRM, Нова Пошта
...
lib/
  courseData.ts           # ALL course content (2390 lines, ~113KB) — modules, lessons, quizzes
  progressContext.tsx     # Progress state via localStorage ("ecommerce_basic_progress")
...
| `--accent` | Orange — CTAs, active states (`#f97316` dark / `#ea580c` light) |
| `--accent-hover` | Lighter/darker orange on hover |
...
File is 2390 lines / ~113KB — source of truth for all course content. Do not duplicate content elsewhere.
...
**Module titles:**
- module-1: "Вибір платформи" (3 lessons + quiz)
- module-2: "Каталог та товари" (3 lessons + quiz)
- module-3: "Оформлення замовлення та оплата" (3 lessons + quiz)
- module-4: "CRM та зростання" (3 lessons + quiz + artifact)
...
- `localStorage` key: `"ecommerce_basic_progress"` (JSON array of completed lesson IDs)
